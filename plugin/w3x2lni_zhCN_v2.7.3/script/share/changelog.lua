...
{
    version = '2.7.3',
    { 'FIX', '修正命令行模式可能无法加载本地插件的问题' },
    { 'FIX', '修正slk后科技的快捷键失效的问题（仅1.32）' },
},
{
    version = '2.7.2',
    { 'NEW', '支持 1.32.7' },
    { 'FIX', '修正转换obj可能失败的问题' },
    { 'FIX', '修正1.32+地图的一些兼容问题' },
    { 'FIX', '修正slk文件的一个解析错误' },
    { 'FIX', '修正slk后基于命令光环的技能失效的问题'},
},
{
    version = '2.7.1',
    { 'FIX', '修正对美术资源特殊字段的支持' },
},
{
    ...
    { 'NEW', '支持 1.32' },
    { 'CHG', '改进脚本优化时混淆函数名的规则'},
    { 'FIX', '修正slk时描述中的错误公式导致转换失败的问题' },
    { 'FIX', '修正slk旧版lni地图可能误报找不到脚本的问题' },
    { 'FIX', '修正脚本优化时开启混淆可能损坏脚本的问题' },
    { 'FIX', '修正脚本文件巨大时lni转换失败的问题' },
},
{
    version = '2.6',
    { 'NEW', '支持 1.31' },
    { 'FIX', '修正slk时描述中的错误公式导致失败的问题' },
},
{
    version = '2.5',
    { 'NEW', '增加额外检查选项', '会检查地图数据的合理性' },
    { 'CHG', '更换 Lua5.3 为 Lua5.4'},
    { 'CHG', '更换 lpeg 为 lpeglabel'},
    { 'CHG', '高级Lni语法大幅度修改,基础部分没有影响'},
    { 'CHG', '优化装饰物改为优化装饰物与可破坏物' },
    { 'CHG', '需要返回实数的地方返回整数不再是语法错误' },
    { 'FIX', '修正实数在转换过程中产生的误差'},
    { 'FIX', '修正报告页面显示的问题'},
    ...
    { 'FIX', '修正值为0的平衡常数在转换后丢失的问题' },
    { 'FIX', '修正slk后随机野怪会随机到特殊单位的问题' },
},
{
    version = '2.4',
    ...
    { 'FIX', '修正物编中的垃圾数据会导致转换失败的问题', '坑爹暴雪往物编里塞垃圾' },
    { 'FIX', '修正某些地图脚本解析错误的问题', '旧的语法解析没有全词匹配`null`' },
    { 'FIX', '修正地图描述过长导致编辑器崩溃的问题' },
    { 'FIX', '修正同名触发器在lni后丢失的问题' },
},
{
    version = '2.3',
    { 'NEW', '重写GUI' },
