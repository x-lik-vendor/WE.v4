...
local function parse_id(w2l, metadata, id, meta, type, has_level)
    ...
    local hint_key = meta.displayName .. '_HINT'
    local hint = w2l:get_editstring(hint_key)
    local data = {
        ['id'] = id,
        ...
        ['displayname'] = w2l:get_editstring(meta.displayName),
        ['hint'] = hint ~= hint_key and hint or nil,
    }
