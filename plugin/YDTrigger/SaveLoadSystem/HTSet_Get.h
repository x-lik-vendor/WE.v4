...
#  define YDTRIGGER_ubersplat(SG)                       YDTRIGGER_HT##SG##(UbersplatHandle)
#  define YDTRIGGER_frame(SG)                           YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_doodad(SG)                          YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_techcode(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_buffcode(SG)                        YDTRIGGER_HT##SG##(Integer)
