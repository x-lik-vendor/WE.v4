...
function YDWEVersion_Display takes nothing returns boolean
    call DisplayTimedTextToPlayer(GetTriggerPlayer(), 0, 0, 30,"|cFF1E90FF当前编辑器版本为： |r|cFF00FF00LKWE " + YDWE_VERSION_STRING)
    return false
endfunction
...
function YDWEVersion_Init takes nothing returns nothing
    ...
    loop
        exitwhen i == 12
        call TriggerRegisterPlayerChatEvent(t, Player(i), "LKWE Version", true)
        set i = i + 1
    endloop
